...
pip install awscli
```
This was helpful as it also install python in cygwin, which we needed to run rastervision and scripts/console later. Python, pip and apt-cyg can be installed in the intall process but there is no harm in running the commands to make sure. It is necessary to make sure that wget/ssh commands are installed in cygwin. This needs to be activated during the cygwin set up. 

<img src="images/wget_cygwin.png" alt"7th Test" width="200">
Image taken from the [yjwon on stack exchange](https://superuser.com/questions/693284/wget-command-not-working-in-cygwin).

<img src="images/cygwin_5.jpg" alt"7th Test" width="200">
Image taken from the [Oracle Help Center](https://docs.oracle.com/cd/E24628_01/install.121/e22624/preinstall_req_cygwin_ssh.htm#EMBSC150).
